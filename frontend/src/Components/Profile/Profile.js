...
export default class Profile extends Component {
  ...
  disconnect() {
    AuthService.deleteCurrentUser().then(() => {
    ...
    return (
      <div className="profil">
        <div className="container">
          ...
          <p>
            <strong>Points:</strong> {currentUser.points}
          </p>
          <p>
            ...
            <div>
              {currentUser.userOffers.map((offer) => (
                <p>
                  <div className="title-coupon">{offer.name}</div>
        ...
        <div className="d-flex justify-content-center">
          <button
            ...
            onClick={() => {
              if (
                window.confirm(
                  "Êtes-vous sûr de vouloir supprimer votre compte Bangoo?"
                )
              ) {
                this.delete();
              }
